  ...
  return (
    <Card sx={{ maxWidth: 700  }}>
      ...
      <CardMedia
        component="img"
        height="400"
        image="https://s6.uupload.ir/files/capture_vbsg.jpg"
        alt="Paella dish"
      />
      <CardContent >
      ...
      <Collapse in={expanded} timeout="auto" unmountOnExit>
        <CardContent>
          ...
          <Typography paragraph style={{fontFamily:'icofont' , fontSize:'20px',fontWeight:'normL'}}>
            Heat 1/2 cup of the broth in a pot until simmering, add saffron and set
            aside for 10 minutes.
          </Typography>
          <Typography paragraph style={{fontFamily:'icofont' , fontSize:'20px',fontWeight:'normal'}}>
          ...
          <Typography style={{fontFamily:'icofont' , fontSize:'20px',fontWeight:'normal'}}>

...
function Formdis(props) {
  ...
  const onChange = (imageList, addUpdateIndex) => {
    ...
    setImages(imageList);
    // console.log(window.URL.createObjectURL(imageList[0].file));
    setImageUrl(imageList[0].file);
    picture = imageList[0].file;
  ...
  const [pictures, setpic] = useState([]);
        ...
        >
          ...
          >
            <Grid item xs={2} sm={4} md={4}>
              <FormControlLabel
                control={
                  <Switch checked={fchecked} onChange={ftoggleChecked} />
                }
                label="food"
              />
            </Grid>
            <Grid item xs={2} sm={4} md={4}>
              <FormControlLabel
                control={
                  <Switch checked={cchecked} onChange={ctoggleChecked} />
                }
                label="cloth"
              />
            </Grid>
            <Grid item xs={2} sm={4} md={4}>
              <FormControlLabel
                control={
                  <Switch checked={schecked} onChange={stoggleChecked} />
                }
                label="service"
              />
            </Grid>

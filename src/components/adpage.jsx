...
import {
    Button,Typography, Container,Grid,Alert, CircularProgress
  } from '@mui/material';
  ...
  return (
    ...
    <Grid >
      <div class="slider" style={{left:'290px',position:'absolute'}}>
        ...
        <label for="id1">
            <img src="https://s6.uupload.ir/files/p1_tsfj.jpg" width="50" height="70"/>
        </label>
        <img src="https://s6.uupload.ir/files/p1_tsfj.jpg"/>
        
        <input type="radio" name="slide_switch" id="id2"/>
        <label for="id2">
            <img src="https://s6.uupload.ir/files/03_jng6.jpg" width="50" height="70"/>
        </label>
        <img src="https://s6.uupload.ir/files/03_jng6.jpg"/>
        
        <input type="radio" name="slide_switch" id="id3"/>
        <label for="id3">
            <img src="https://s6.uupload.ir/files/p2_syi9.jpg" width="50" height="70"/>
        </label>
    ...
    <Card container sx={{ maxWidth: 370 , marginLeft:'30px'}} >
      <CardContent style={{textAlign:'left',lineHeight:'175%'}}>
        <Typography  style={{display:'inline',borderRadius:'4px',textShadow:'0 0 1px grey',color:'#556749',fontSize:'30px',marginLeft:'-5px'}}>
        &nbsp;Red Jacket&nbsp;
        </Typography>
        <div
            style={{
    ...
    <Card container sx={{ maxWidth: 370 , marginLeft:'30px'}} >
      <CardContent style={{textAlign:'left',lineHeight:'175%'}}>
        <Typography  style={{display:'inline',borderRadius:'4px',color:'#556749',marginLeft:'-5px'}}>
            <span style={{fontSize:'20px',textShadow:'0 0 1px grey'}}>&nbsp;Description&nbsp;</span>
        
        <br/>
        <span style={{fontSize:'14px'}}>It was a gift from my friend so it is new.It's fit to size meduim to large and a gift for you.</span>
        </Typography>
